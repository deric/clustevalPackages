...
public class HyperCubeCornersDataSetGenerator extends DataSetGenerator {
	 ...
	 */
	public HyperCubeCornersDataSetGenerator(Repository repository,
	 ...
	 * @throws RegisterException
	 */
	public HyperCubeCornersDataSetGenerator(DataSetGenerator other)
			throws RegisterException {
		super(other);
	}
	...
	protected DataSet generateDataSet() throws DataSetGenerationException {
		try {
			...
			rEngine.eval("result <- mlbench.hypercube(n=" + this.numberOfPoints
