...
public class RingnormDataSetGenerator extends DataSetGenerator {
	 ...
	 */
	public RingnormDataSetGenerator(Repository repository, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public RingnormDataSetGenerator(DataSetGenerator other)
			throws RegisterException {
		super(other);
	}
	...
	protected DataSet generateDataSet() throws DataSetGenerationException {
		try {
			...
			rEngine.eval("result <- mlbench.ringnorm(n=" + this.numberOfPoints
